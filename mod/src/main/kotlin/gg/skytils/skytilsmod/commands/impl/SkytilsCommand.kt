...
object SkytilsCommand {
    ...
    fun stats(
        ...
        PartyFinderStats.printStats(name ?: mc.player!!.gameProfile.name, false)
    }
    ...
    fun resetTracker(
        ...
        val trackerObj = Tracker.getTrackerById(tracker) ?: throw IllegalArgumentException(
    ...
    fun reloadSlayer() {
        for (entity in mc.world!!.getOtherEntities(
            mc.player,
    ...
    fun pricePaidCommand(
        ...
        val extraAttr = ItemUtil.getExtraAttributes(mc.player?.mainHandStack) ?: return
    ...
    fun dungeonMapMapDataCommand() {
        ...
        if (data != null) {
            UDesktop.setClipboardString(data.colors.contentToString())
